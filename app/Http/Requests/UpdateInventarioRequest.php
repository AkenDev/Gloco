...
class UpdateInventarioRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        // Get the current inventario's ID from the route
        $inventarioId = $this->route('inventario')->idInventario;
        
        return [
            'codInventario' => "required|unique:inventarios,codInventario,{$inventarioId},idInventario|max:50",
